...
function createElementWithLink(
  newId,
  c4Name,
  c4Type,
  c4Description,
...
`;
  ...
  let iconY = 0;
  let linkIconObj = `           <object id="${newId}_linkicon" label="" link="${escX(
    linkValue
  )}">
...
function createElementWithoutLink(
  newId,
  c4Name,
  c4Type,
  c4Description,
  ...
  console.log(
    "createElementWithoutLink: " + c4Name + "" + c4Type + " " + c4Description
  );
  style = setShapeColor(style, e);
